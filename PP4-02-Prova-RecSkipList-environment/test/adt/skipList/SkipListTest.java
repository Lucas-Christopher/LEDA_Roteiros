...
public class SkipListTest {
	...
	RecursiveSkipListImpl<String> skip2;

	@Before
	public void setUp() {
		skip = new RecursiveSkipListImpl<String>(4);
		skip2 = new RecursiveSkipListImpl<String>(7);
	}
	
	@Test
	public void testToArrayByHeight() {
		assertEquals("[]", Arrays.toString(skip2.toArrayByHeight()));
		skip2.insert(10, "A", 3);
		skip2.insert(20, "B", 1);
		skip2.insert(3, "E", 6);
		skip2.insert(0, "C", 1);
		skip2.insert(15, "D", 2);
		skip2.insert(5, "E", 3);
		skip2.insert(44, "EE", 5);
		
		assertEquals("[<3,6>, <44,5>, <5,3>, <10,3>, <15,2>, <0,1>, <20,1>]", Arrays.toString(skip2.toArrayByHeight()));
	}
