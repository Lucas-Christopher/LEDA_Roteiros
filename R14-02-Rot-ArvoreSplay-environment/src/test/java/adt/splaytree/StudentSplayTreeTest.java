...
//		assertEquals(4, splay.size());
//		assertEquals(2, splay.height());
//		assertArrayEquals(new Integer[] { 99, -14, -15, 5 }, splay.preOrder());
//		
//		splay.insert(7);
//		assertEquals(5, splay.size());
//		assertEquals(4, splay.height());
//		assertArrayEquals(new Integer[] { 99, 7, 5, -14, -15 }, splay.preOrder());
//		
//		splay.insert(8);
//		assertEquals(6, splay.size());
//		assertEquals(4, splay.height());
//		assertArrayEquals(new Integer[] { 99, 7, 5, -14, -15, 8 }, splay.preOrder());
//		
//	}
